...
/** Uma agenda com TODO campo preenchido — é o que faz a ida e volta provar algo.
 *
 *  Um campo deixado vazio aqui passaria pelo teste sem ser exercitado, que é
 *  precisamente como um campo se perde sem ninguém ver. */
const COMPLETA: Interacao = {
  id: 'i-1',
  frente: 'imprensa' as Interacao['frente'],
  ...
  extensao: { formato: 'entrevista' } as Interacao['extensao'],
  temas: [7, 9],
  areas: [2],
  participacoes: [
    { pessoa_aegea_id: 'aegea-1', papel: 'porta_voz', presenca: 'presente' },
  ] as Interacao['participacoes'],
  consulta: null,
  alegacoes: [],
...
describe('a ida e a volta', () => {
  it.each(IDA_E_VOLTA)('%s sobrevive ao caminho inteiro', (campo) => {
